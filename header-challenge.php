...
-833 480 -4 0 -7 -216 -7 -480z" />
  ...
  <div id="intro-section" data-bid="intro-section" class="sb sib-intro-section" style="height: 400px;">
    <div class="ss-s ss-bg join">
      <div class="sb-m" style="background-image: url(<?php the_field('signature_banner_image'); ?>);background-repeat: no-repeat; " ></div>
      <div class="sc" style="width:1200px;">
        <div data-sid="intro-section_0" class="sie-intro-section_0 se " style="transform: scale(1, 1) translate(0px, 0px);">
          <h3 class="se-t sie-intro-section_0-text st-m-subheading st-d-subheading se-rc"> <?php the_field('signature_banner_title'); ?></h3>
        </div>
        <div data-sid="intro-section_1" class="sie-intro-section_1 se " style="transform: scale(1, 1) translate(0px, 0px);">
          <h2 class="se-t sie-intro-section_1-text st-m-heading st-d-heading se-rc"><?php the_field('signature_banner_sub_title'); ?></h2>
        </div>
      </div>
    </div>
  </div>