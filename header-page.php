...
<head>
  ...
  <link rel="stylesheet" type="text/css"href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/animate.min.css" />
  <link rel="stylesheet" type="text/css" href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/showit.css" />
	
  <link rel="stylesheet" type="text/css" href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/page.css " />
...
-833 480 -4 0 -7 -216 -7 -480z"/>
    ...
    <div class="ss-s ss-bg" style="background-image: url(<?php the_field('header_background_image'); ?>);background-repeat: no-repeat;background-size: cover ">
      ...
      <div class="sc" style="width:1200px;">
		 ...
		 <div data-sid="intro-section_0" class="sie-intro-section_0 se " style="transform: scale(1, 1) translate(0px, 0px);">
          <h3 class="se-t sie-intro-section_0-text st-m-subheading st-d-subheading se-rc"> <?php the_field('header_sub_title'); ?></h3>
        </div>
		  
        <div data-sid="intro-section_1" class="sie-intro-section_1 se " style="transform: scale(1, 1) translate(0px, 0px);">
			
			
          <h2 class="se-t sie-intro-section_1-text st-m-heading st-d-heading se-rc">
